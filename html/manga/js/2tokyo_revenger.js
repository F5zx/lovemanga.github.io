...
switchLeft.addEventListener("click", () => {
  if (currentPage <= 1) {
    image.src = `../../img/tokyo_revenger/tokyo_revenger_tom2/${pages[pages.length - 1]}.jpg`;
    currentPage = pages.length;
  } else {
    image.src = `../../img/tokyo_revenger/tokyo_revenger_tom2/${currentPage - 1}.jpg`;
    --currentPage;
  }
});
...
switchRight.addEventListener("click", () => {
  if (currentPage >= pages.length) {
    image.src = `../../img/tokyo_revenger/tokyo_revenger_tom2/${pages[0]}.jpg`;
    currentPage = 1;
  } else {
    image.src = `../../img/tokyo_revenger/tokyo_revenger_tom2/${currentPage + 1}.jpg`;
    ++currentPage;
